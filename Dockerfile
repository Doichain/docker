...
RUN mkdir .namecoin && \
	sudo git clone --branch '0.0.3' https://github.com/Doichain/core.git namecoin-core && \
	cd namecoin-core && \
	sudo ./autogen.sh && \
...
RUN sudo curl https://install.meteor.com/ | sh && \
	sudo git clone --branch '0.0.3' https://github.com/Doichain/dApp.git /home/doichain/dapp && \
