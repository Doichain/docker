...
DOCKER_TESTNET=$(DOCKER_RUN) -p 18338:18338 -p 18339:18339 --name=doichain-testnet --hostname=doichain-testnet
DOCKER_ALICE=$(DOCKER_RUN) -p 18445:18445 -p 18443:18443 --name=doichain-alice --hostname=doichain-alice
